...
const config = {
    serverInfo: {
        ...
        serverName: "Astral SMP", /*Server name*/
        serverIp: "astralsmp.ddns.net", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "1278056577269502044" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
